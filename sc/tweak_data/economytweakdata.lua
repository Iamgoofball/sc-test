...
function EconomyTweakData:init()
	...
	self.bonuses.concealment_p2.stats = {concealment = 2, spread = -1, recoil = -1}
	self.bonuses.concealment_p2.damage_near_mul = -100
	self.bonuses.concealment_p2.damage_far_mul = -200
	self.bonuses.concealment_p3.name_id = "bm_menu_bonus_concealment_p3"
	self.bonuses.concealment_p3.stats = {concealment = 3, spread = -2, recoil = -2}
	self.bonuses.concealment_p3.damage_near_mul = -200
	self.bonuses.concealment_p3.damage_far_mul = -200
	...
	self.bonuses.team_exp_money_p3.money_multiplier = 1.1
end
