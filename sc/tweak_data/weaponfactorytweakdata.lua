...
function WeaponFactoryTweakData:_init_sights()
	...
	self.parts.shortdot_normal = {
		...
		stats = { value = 8, zoom = 6, recoil = 1, concealment = -5},
...
function WeaponFactoryTweakData:_init_m4()
	...
	self.parts.wpn_fps_upg_m4_m_straight = {
		...
		has_description = true,
		desc_id = "bm_wp_upg_vintage_desc",
...
function WeaponFactoryTweakData:_init_akm()
	...
	self.wpn_fps_ass_akm.adds = {
		...
		wpn_fps_upg_ass_ak_b_zastava = { "wpn_upg_ak_m_akm" },
	}
...
function WeaponFactoryTweakData:_init_akm_gold()
	...
	self.wpn_fps_ass_akm_gold.adds = {
		...
		wpn_fps_upg_ass_ak_b_zastava = { "wpn_upg_ak_m_akm_gold" },
	}
...
function WeaponFactoryTweakData:_init_serbu()
	...
	self.wpn_fps_shot_serbu.override = {
		...
		wpn_fps_upg_a_custom = {
			desc_id = "bm_wp_upg_a_custom_desc"
		},
...
function WeaponFactoryTweakData:_init_g17()
	...
	self.parts.wpn_fps_pis_g17_m_ext = {
		pcs = {},
		type = "magazine",
		name_id = "bm_wp_g18c_m_mag_33rnd",
		a_obj = "a_m",
		dlc = "sc",
		is_a_unlockable = true,
		unit = "units/payday2/weapons/wpn_fps_pis_g17_pts/wpn_fps_pis_g17_m_extended",
		alt_icon = "guis/textures/pd2/blackmarket/icons/mods/wpn_fps_pis_g18c_m_mag_33rnd",
		stats = {
			value = 6,
			spread_moving = -3,
			extra_ammo = 6,
	...
	self.parts.wpn_fps_pis_g17_m_ext.material_config = Idstring("units/payday2/weapons/wpn_fps_pis_g17_pts/wpn_fps_pis_g17_m_extended")
	self.parts.wpn_fps_pis_g17_m_ext.thq_material_config = Idstring("units/payday2/weapons/wpn_fps_pis_g17_pts/wpn_fps_pis_g17_m_extended_cc_thq")
	...
	self.parts.wpn_fps_pis_g17_m_ext.third_unit = "units/payday2/weapons/wpn_third_pis_g17_pts/wpn_third_pis_g17_m_extended"
...
function WeaponFactoryTweakData:_init_raging_bull()
	...
	self.parts.wpn_fps_pis_rage_b_comp2 = {
		...
		desc_id = "bm_ap_weapon_mod_sc_desc",
		a_obj = "a_b",
	...
	self.parts.wpn_fps_ammo_mag_type = {
		type = "ammo",
		a_obj = "a_m",
	...
	self.wpn_fps_pis_judge.override = {
		...
		wpn_fps_upg_a_explosive = {
			...
			custom_stats = {
				...
				block_b_storm = true,
				rays = 1,
				damage_near_mul = 999999999999999,
				damage_far_mul = 999999999999999,
				bullet_class = "InstantExplosiveBulletBase",
				ammo_pickup_min_mul = 0.085,
...
function WeaponFactoryTweakData:_init_m249()
	...
	self.wpn_fps_lmg_m249.override = {
		wpn_fps_upg_ammo_half_that = {
			...
			custom_stats = {ammo_pickup_min_mul = 0.8, ammo_pickup_max_mul = 0.8, movement_speed = 1.2},	
		}
	}
...
function WeaponFactoryTweakData:_init_rpk()
	...
	self.parts.wpn_lmg_rpk_m_drum_upgrade = {
		type = "magazine",
		name_id = "bm_wp_rpk_m_drum",
		a_obj = "a_m",
		bullet_objects = {prefix = "g_bullet_", amount = 1},
	...
	self.parts.wpn_lmg_rpk_m_drum.third_unit = "units/pd2_dlc_gage_lmg/weapons/wpn_third_lmg_rpk_pts/wpn_third_lmg_rpk_m_standard"
	self.parts.wpn_lmg_rpk_m_drum_upgrade.third_unit = "units/pd2_dlc_gage_lmg/weapons/wpn_third_lmg_rpk_pts/wpn_third_lmg_rpk_m_drum"
	...
	self.wpn_fps_sho_ben.override = {
		...
		wpn_fps_upg_a_explosive = {
			...
			custom_stats = {
				...
				damage_far_mul = 999999999,
				bullet_class = "InstantExplosiveBulletBase",
				ammo_pickup_min_mul = 0.155555555556,
				ammo_pickup_max_mul = 0.155555555556
			}
		}
	}
...
function WeaponFactoryTweakData:_init_gre_m79()
	...
	self.parts.wpn_fps_upg_a_grenade_launcher_explosive = {
		pcs = {},
		type = "ammo",
...
function WeaponFactoryTweakData:_init_scorpion()
	...
	self.parts.wpn_fps_smg_scorpion_m_extended = {
		pcs = {},
		type = "magazine",
		name_id = "bm_wp_scorpion_m_extended_sc",
		texture_bundle_folder = "dlc1",
		bullet_objects = {prefix = "g_bullet_", amount = 1},
		a_obj = "a_m",
...
function WeaponFactoryTweakData:create_bonuses(tweak_data, weapon_skins)
	...
	self.parts.wpn_fps_upg_bonus_concealment_p2 = {
		...
		unit = "units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy",
		third_unit = "units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy",
		stats = {value = 1, concealment = 2, spread = -1, recoil = -1},
		custom_stats = {
			damage_near_mul = -100,
			damage_far_mul = -200
		},
	...
	self.parts.wpn_fps_upg_bonus_concealment_p3 = {
		...
		unit = "units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy",
		third_unit = "units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy",
		stats = {value = 1, concealment = 3, spread = -2, recoil = -2},
		custom_stats = {
			damage_near_mul = -200,
			damage_far_mul = -400
		},
	...
	self.parts.wpn_fps_upg_bonus_damage_p1 = {
		...
		unit = "units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy",
		third_unit = "units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy",
		stats = {value = 1, damage = 3, total_ammo_mod = -1},
		custom_stats = {ammo_pickup_min_mul = 0.95, ammo_pickup_max_mul = 0.95},
		internal_part = true,
		perks = {"bonus"},
		texture_bundle_folder = "boost_in_lootdrop",
		sub_type = "bonus_stats",
	...
	self.parts.wpn_fps_upg_bonus_damage_p2 = {
		...
		unit = "units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy",
		third_unit = "units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy",
		stats = {value = 1, damage = 5, total_ammo_mod = -2},
		custom_stats = {ammo_pickup_min_mul = 0.9, ammo_pickup_max_mul = 0.9},
		internal_part = true,
		perks = {"bonus"},
		texture_bundle_folder = "boost_in_lootdrop",
		sub_type = "bonus_stats",
	...
	self.parts.wpn_fps_upg_bonus_total_ammo_p1 = {
		...
		third_unit = "units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy",
		stats = {value = 1, damage = -3, total_ammo_mod = 1},
		custom_stats = {ammo_pickup_min_mul = 1.05, ammo_pickup_max_mul = 1.05},
		internal_part = true,
		perks = {"bonus"},
		texture_bundle_folder = "boost_in_lootdrop",
		sub_type = "bonus_stats",
	...
	self.parts.wpn_fps_upg_bonus_total_ammo_p3 = {
		...
		unit = "units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy",
		third_unit = "units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy",
		stats = {value = 1, damage = -8, total_ammo_mod = 3},
		custom_stats = {ammo_pickup_min_mul = 1.15, ammo_pickup_max_mul = 1.15},
		internal_part = true,
		perks = {"bonus"},
		texture_bundle_folder = "boost_in_lootdrop",
		sub_type = "bonus_stats",
	...
	self.parts.wpn_fps_upg_bonus_team_exp_money_p3 = {
		...
		third_unit = "units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy",
		stats = {value = 1},
		custom_stats = {exp_multiplier = 1.1, money_multiplier = 1.1},
		internal_part = true,
		perks = {"bonus"},
		has_description = true,
		texture_bundle_folder = "boost_in_lootdrop",
...
function WeaponFactoryTweakData:_init_mg42()
	...
	self.wpn_fps_lmg_mg42.override = {
		wpn_fps_upg_ammo_half_that = {
			...
			custom_stats = {ammo_pickup_min_mul = 0.75, ammo_pickup_max_mul = 0.75, movement_speed = 1.2},	
		}
	}
...
function WeaponFactoryTweakData:_init_plainsrider()
	...
	self.parts.wpn_fps_upg_a_bow_explosion = {
		...
		stats = {damage = 119, total_ammo_mod = -16, spread = -6, recoil = -5},
		custom_stats = {
	...
	self.parts.wpn_fps_upg_a_bow_poison = {
		...
		stats = {damage = 0, total_ammo_mod = 0},
		custom_stats = {
			launcher_grenade = "bow_poison_arrow",
			ammo_pickup_min_mul = 0, ammo_pickup_max_mul = 0,
			dot_data = {
				type = "poison",
...
function WeaponFactoryTweakData:_init_hunter()
	...
	self.parts.wpn_fps_upg_a_crossbow_explosion = {
		...
		stats = {damage = 119, total_ammo_mod = -16, spread = -8, recoil = -5},
		custom_stats = {
...
function WeaponFactoryTweakData:_init_arblast()
	...
	self.parts.wpn_fps_bow_arblast_m_poison = {
		...
		stats = {damage = 0, total_ammo_mod = 0},
		custom_stats = {
			launcher_grenade = "arblast_poison_arrow", ammo_pickup_min_mul = 0, ammo_pickup_max_mul = 0,
			dot_data = {
				type = "poison",
				custom_data = {dot_length = nil, hurt_animation_chance = nil}
			}
	...
	self.parts.wpn_fps_bow_arblast_m_explosive = {
		...
		stats = {damage = 80, total_ammo_mod = -16, spread = -10, recoil = -6},
		custom_stats = {
...
function WeaponFactoryTweakData:_init_frankish()
	...
	self.parts.wpn_fps_bow_frankish_m_poison = {
		...
		stats = {damage = 0, total_ammo_mod = 0},
		custom_stats = {
			launcher_grenade = "frankish_poison_arrow", ammo_pickup_min_mul = 0, ammo_pickup_max_mul = 0,
			dot_data = {
				type = "poison",
				custom_data = {dot_length = nil, hurt_animation_chance = nil}
			}
...
function WeaponFactoryTweakData:_init_long()
	...
	self.parts.wpn_fps_bow_long_m_poison = {
		...
		stats = {damage = 0, total_ammo_mod = 0},
		custom_stats = {
			launcher_grenade = "long_poison_arrow", ammo_pickup_min_mul = 0, ammo_pickup_max_mul = 0,
			dot_data = {
				type = "poison",
				custom_data = {dot_length = nil, hurt_animation_chance = nil}
			}
...
function WeaponFactoryTweakData:_init_sparrow()
	...
	self.parts.wpn_fps_pis_sparrow_b_comp = {
		...
		stats = {value = 1, spread = 2, recoil = -1, concealment = -3, damage = 5},
		dlc = "berry",
		forbids = {
			"wpn_fps_upg_ns_pis_large",
			"wpn_fps_upg_ns_pis_medium",
...
function WeaponFactoryTweakData:_init_sr2()
	...
	self.parts.wpn_fps_smg_sr2_s_unfolded = {
		...
		stats = {value = 1, recoil = 1, damage = 2},
...
if self.wpn_fps_shot_toz66 then
	...
	self.wpn_fps_shot_toz66.override = {
		wpn_fps_upg_a_explosive = {
			stats = {
				value = 10,
				recoil = -5,
	...
	--table.list_append(self.wpn_fps_shot_toz66.uses_parts, {
	--	"wpn_fps_upg_a_slug_fire"
	--})
end
...
if self.wpn_fps_shot_toz34 then
	...
	--table.list_append(self.wpn_fps_shot_toz34.uses_parts, {
	--	"wpn_fps_upg_a_slug_fire"
	--})
end
...
self.parts.wpn_fps_ass_svk12_barrel.custom_stats = {
		ammo_pickup_min_mul = 0.6,
		ammo_pickup_max_mul = 0.6
	}
self.parts.wpn_fps_ass_svk12_barrel.stats = {
		value = 7,
		recoil = -1,
		spread = 3,
		total_ammo_mod = -8,
...
self.parts.wpn_fps_ass_svk12_barrel.forbids = {
		"wpn_fps_ass_ak12_mag_quad"
	}
self.parts.wpn_fps_ass_ak12_mag_quad.stats = {
			value = 3,
			spread_moving = -2,
			concealment = -3,
			extra_ammo = 15,
...
self.parts.wpn_fps_ass_ak12_mag_quad.desc_id = "bm_wp_upg_quad_desc"
self.parts.wpn_fps_ass_ak12_mag_quad.has_description = true
...
self.parts.wpn_fps_pis_shatters_fury_body_standard.custom_stats = {reload_speed_mult = 0.85}
self.parts.wpn_fps_pis_shatters_fury_body_smooth.custom_stats = {reload_speed_mult = 0.85}
