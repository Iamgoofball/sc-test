Hooks:Add("LocalizationManagerPostInit", "SC_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["bm_wp_upg_vintage_desc"] = "INCREASES YOUR RELOAD SPEED BY 10%.",
		["bm_sc_scorpion_double_mag"] = "INCREASES YOUR RELOAD SPEED BY 50%.",
		["bm_wp_scorpion_m_extended_sc"] = "Double Magazine",
		["bm_wp_upg_mil_sc"] = "Milspec Mag",
		["bm_wp_upg_tac_sc"] = "Tactical Mag",
		["bm_wp_upg_mil_desc"] = "SLOWS DOWN YOUR RELOAD SPEED BY 10%.",
		["bm_wp_upg_drum_desc"] = "SLOWS DOWN YOUR RELOAD SPEED BY 30%.",
		["bm_wp_upg_drum2_desc"] = "SLOWS DOWN YOUR RELOAD SPEED BY 40%.",
		["bm_wp_upg_quad_desc"] = "SLOWS DOWN YOUR RELOAD SPEED BY 15%.",
		["bm_wp_upg_quad2_desc"] = "SLOWS DOWN YOUR RELOAD SPEED BY 25%.",
