...
function CopBase:_chk_spawn_gear()
	if Global.level_data.level_id == "pines" or Global.level_data.level_id == "roberts" or Global.level_data.level_id == "cane" or Month == "12" then
		...
		if self._tweak_table == "spooc" or self._tweak_table == "taser" or self._tweak_table == "tank" or self._tweak_table == "shield" or self._tweak_table == "sniper" or self._tweak_table == "phalanx_minion" or self._tweak_table == "boom" or self._tweak_table == "rboom" then
